...
public interface PersistenceSessionJdo extends PersistenceSession {

    javax.jdo.PersistenceManager getPersistenceManagerJdo();
    /**
     * Convenient equivalent to {@code getPersistenceManager()}.
     * @return
     */
    default javax.jdo.PersistenceManager pm() {
        return getPersistenceManagerJdo();
    }
	...
	static PersistenceSessionJdo current() {
		return PersistenceSession.current(PersistenceSessionJdo.class)
				.getSingleton()
				.orElse(null);
	}
